...
function createUser({ name, isPaid }) { } // this is not the actual way of declaring but this is how you do it inside the funciton okay.
...
createUser({ name: "ROhan", isPaid: true }); // if we want now we can't define any more values like email because it is not defined in the function createUser. but we can do that here is how it will show in the above section with "this is how"
