...
let data4 = [1, 2, "3"]; // Now it will have all the mix value that's how you should write the syntax. I think you get it okay.
// also there is one more classic situation:- 
let pi = 3.14; // by this you can assign the direct value its can't be changed...
// her is the more real use case scenario okay . here it is :- 
// suppose you making a seat booking site for aeroplane 
// here is the example
let seatAllotment; // by writing this you can only access or write this 3 value. You can't over write it .
seatAllotment = "aisle";
