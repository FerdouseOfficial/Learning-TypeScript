...
const getMoreSearchData = <T>(products: T[]): T => { // remember in many code base you will see <T,> this okay no need to become confuse this is okay. People who use react by using the comman they make sure that this is not a JSX syntax. This is a generics type okay.
    // do some database operations..... 
    const myIndex = 4;
    return products[myIndex];
}
